namespace Topic_6___Random_Numbers
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The first dice number is " + diceNum1);
            Console.WriteLine("The second dice number is " + diceNum2);
            if (diceNum1 == diceNum2)
                Console.WriteLine("The numbers are the same! The sum of " + diceNum1 + " and " + diceNum2 + " is " + (diceNum1 + diceNum2));
            if (diceNum1 != diceNum2)
                Console.WriteLine("The numbers are different! The sum of " + diceNum1 + " and " + diceNum2 + " is " + (diceNum1 + diceNum2));
